const x= require('./scss/selectDepartamentosRes.scss');
import * as am4core from "@amcharts/amcharts4/core";
import * as am4charts from "@amcharts/amcharts4/charts";

let e= document.getElementById('select');
let b= document.getElementById('getSelect');
b.addEventListener('click',function(){
    console.dir(e.options[e.selectedIndex].value);
});
...
window.chart = container.createChild(am4charts.PieChart);
